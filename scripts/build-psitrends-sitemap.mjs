// Publish only after all twelve first-party client routes pass live acceptance.
...
if (entries.length !== 12 || new Set(entries).size !== 12) throw new Error('Unexpected sitemap routes');
...
`);
console.log('Built twelve canonical client URLs; production publication remains gated on live acceptance.');
